                ...
                <div>
                    ...
                    <section className="relative w-full h-[550px] md:h-[650px] overflow-hidden shadow-xl">
                        ...
                        >
                            <div className="p-6 md:p-10 max-w-full space-y-6">
                                ...
                                <button
                                    onClick={() => navigate('/Parentfindclinics')}
                    ...
                    <section className="bg-gradient-to-r from-yellow-100 via-gray-100 to-yellow-200 py-20">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-6 md:px-20">
                            {[
                                { icon: <PawPrint className="w-10 h-10 text-yellow-500" />, title: 'Healthy Diet', color: 'pink', desc: 'A balanced diet keeps your pet energetic and strong. Tailor food choices by age and breed.' },
                                { icon: <HeartPulse className="w-10 h-10 text-green-500" />, title: 'Daily Exercise', color: 'green', desc: 'Physical activity improves your pet’s physical and mental health. Make playtime a priority!' },
                                { icon: <Stethoscope className="w-10 h-10 text-purple-500" />, title: 'Vet Checkups', color: 'purple', desc: 'Regular visits help detect issues early. Keep vaccinations and exams up-to-date.' }
                            ].map((tip, i) => (
                                <motion.div
                                    key={i}
                    ...
                    {/* Call to Action */}
                    <section className="py-20 bg-gradient-to-r from-yellow-100 via-gray-100 to-yellow-200 text-center text-white">
                        <h2 className="text-5xl font-bold text-blue-950 flex items-center justify-center py-5">Ready to Take Care of Your Pet?</h2>
                        <p className="text-xl text-black mb-6">Join us today and connect with the best clinics near you!</p>
                        <motion.button
                            whileHover={{ scale: 1.05 }}
                            whileTap={{ scale: 0.95 }}
                            className="border-none bg-gray-800 text-white font-bold rounded-bl-xl rounded-tr-xl hover:bg-gray-700 transition-all duration-800 py-2 px-5"
                            onClick={() => navigate('/Parentfindclinics')}
                        >
                            Get Started
                        </motion.button>
